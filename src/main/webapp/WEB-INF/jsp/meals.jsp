...
<section>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <tr>
            ...
            <th><spring:message code="meal.descr"/></th>
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/${meal.id}/edit"><spring:message code="meal.upd"/></a></td>
                <td><form:form method="DELETE" action="${pageContext.request.contextPath}/meals/${meal.id}">
                    <input type="submit" value="<spring:message code="meal.del"/>">
                </form:form>
                </td>
            </tr>
        </c:forEach>
